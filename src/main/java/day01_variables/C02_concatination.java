...
//yukarıdaki ifadelerle anlamlı bir cumle olusturalım
        ...
        System.out.println(ifade1+ifade3+ifade5+ifade4+ifade2); //Ali Can topu bana 1 kere atar mısın?
        System.out.println(ifade1+ifade3+(ifade5+1)+ifade4+ifade2); //Ali Can topu bana 2 kere atar mısın?
        System.out.println(ifade1+ifade3+ifade5+ifade5+ifade4+ifade2); //Ali Can topu bana 11 kere atar mısın?
